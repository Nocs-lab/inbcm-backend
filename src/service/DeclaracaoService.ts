...
import { Declaracoes, Museu, type Arquivo, Arquivistico, Bibliografico, Museologico, type DeclaracaoModel } from "../models";
...
class DeclaracaoService {
  ...
  async declaracaoComFiltros(
    ...
    { anoReferencia: string, status:string, nomeMuseu: string, dataInicio: number, dataFim: number, regiao:string, uf:string }
    ) {
 ...
 */
  ...
  async updateDeclaracao(
    ...
    try {
      const { validate_museologico, validate_bibliografico, validate_arquivistico } = await import("inbcm-xlsx-validator");
      const { museologico, bibliografico, arquivistico } = await import("inbcm-xlsx-validator/schema.js");
      ...
      if (arquivo) {
        ...
        let validate: typeof validate_arquivistico | typeof validate_bibliografico | typeof validate_museologico;
        switch (tipo) {
          case 'arquivistico':
            Modelo = Arquivistico;
