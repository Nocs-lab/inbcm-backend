 ...
 */
  async retificarDeclaracao(req: Request, res: Response) {
    try {
      ...
      await this.declaracaoService.updateDeclaracao(files?.arquivisticoArquivo?.[0], req.body.arquivistico, req.body.arquivisticoErros, novaDeclaracao, 'arquivistico', declaracao.arquivistico);
      await this.declaracaoService.updateDeclaracao(files?.bibliograficoArquivo?.[0], req.body.bibliografico, req.body.bibliograficoErros, novaDeclaracao, 'bibliografico', declaracao.bibliografico);
      await this.declaracaoService.updateDeclaracao(files?.museologicoArquivo?.[0], req.body.museologico, req.body.museologicoErros, novaDeclaracao, 'museologico', declaracao.museologico);
